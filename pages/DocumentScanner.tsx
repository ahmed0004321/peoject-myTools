...
const DocumentScanner: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-background pb-20 animate-fade-in">
            <SectionHeader
                title="DocScanner"
                subtitle="Turn any photo into clean, searchable, and editable digital text in seconds."
                badge="OCR Powered"
            />
            ...
            <div className="max-w-6xl mx-auto px-4 mt-8">
                ...
                <div className="flex justify-center mb-8">
                    <div className="flex bg-inset p-1.5 rounded-2xl border border-border">
                        {[1, 2, 3].map((s) => (
                            <button
                                key={s}
                                onClick={() => (s <= step || scannedPages.length > 0) && setStep(s)}
                                className={`px-6 py-2.5 rounded-xl text-sm font-bold transition-all flex items-center gap-2 ${step === s ? 'bg-emerald-500 text-white shadow-lg' : 'text-secondary hover:text-primary'}`}
                            >
                    ...
                    {step === 1 && (
                        ...
                        >
                            <div className="lg:col-span-2 space-y-6">
                                <div className="bg-surface border border-border rounded-3xl shadow-xl p-1 overflow-y-auto relative group min-h-[450px] lg:aspect-[4/3] flex items-center justify-center bg-black/20">
                                    {isCapturing ? (
                                        ...
                                        <div className="text-center p-4 sm:p-8 space-y-6 sm:space-y-8 w-full max-w-2xl">
                                            <div className="space-y-2 sm:space-y-3">
                                                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-emerald-500/10 rounded-2xl flex items-center justify-center mx-auto text-emerald-500 group-hover:scale-110 transition-transform">
                                                    <Scan size={32} className="sm:hidden" />
                                                    <Scan size={40} className="hidden sm:block" />
                                                </div>
                                                <div className="space-y-1">
                                                    <h3 className="text-xl sm:text-2xl font-bold text-primary">Capture or Upload</h3>
                                                    <p className="text-sm sm:text-base text-secondary">Select a source to begin document scanning.</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                <button
                                                    ...
                                                    className="flex flex-col items-center gap-4 p-6 rounded-2xl border border-border bg-inset hover:border-emerald-500 hover:bg-emerald-500/5 transition-all group/btn disabled:opacity-50"
                                                >
                                                    ...
                                                    <span className="font-bold text-sm text-primary">Use Camera</span>
                                                </button>
                                                ...
                                                >
                                                    ...
                                                    <span className="font-bold text-sm text-primary">Image / Screenshot</span>
                                                </button>
                                                ...
                                                >
                                                    ...
                                                    <span className="font-bold text-sm text-primary">Upload PDF</span>
                                                </button>
                                                ...
                                                >
                                                    ...
                                                    <span className="font-bold text-sm text-primary">Word (DOCX)</span>
                                                </button>
                                            </div>

                                            {isProcessing && (
                                                <div className="flex items-center justify-center gap-3 pt-4 text-emerald-500">
                                ...
                                {scannedPages.length > 0 && (
                                    <div className="flex items-center justify-between p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="font-bold text-primary">{scannedPages.length} Pages Captured</p>
                                                <p className="text-xs text-secondary">Ready for enhancement and OCR</p>
                                            </div>
                                        </div>
                                        <button onClick={() => setStep(2)} className="px-6 py-3 bg-emerald-500 text-white rounded-xl font-bold hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-500/20 flex items-center gap-2">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    {scannedPages.map((page, idx) => (
                                        <div key={page.id} className={`group relative aspect-[3/4] rounded-xl overflow-hidden border-2 transition-all ${activePageIndex === idx ? 'border-emerald-500 scale-105 z-10' : 'border-border'}`}>
                                            <img src={page.processed} className="w-full h-full object-cover" />
                                            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                                                <button onClick={() => { setActivePageIndex(idx); setStep(2); }} className="p-2 bg-white text-black rounded-lg hover:bg-emerald-500 hover:text-white transition-colors">
                                                    <Wand2 size={18} />
                                                </button>
                                    ...
                                    {scannedPages.length === 0 && (
                                        Array(4).fill(0).map((_, i) => (
                                            <div key={i} className="aspect-[3/4] rounded-xl border-2 border-dashed border-border bg-inset/30 flex items-center justify-center text-secondary/20">
                                                <ImageIcon size={24} />
                                            </div>
                                        ))
                                    )}
                    ...
                    {step === 2 && (
                        ...
                        >
                            <div className="lg:col-span-3 space-y-6">
                                <div className="bg-surface border border-border rounded-3xl shadow-xl p-4 flex flex-col items-center justify-center min-h-[60dvh] relative">
                                    {scannedPages.length > 0 ? (
                                        <div className="max-w-full overflow-hidden rounded-lg shadow-2xl border border-border">
                                            <ReactCrop
                                                crop={crop}
                                    ...
                                    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-wrap justify-center gap-2 p-2 bg-surface/90 backdrop-blur-xl rounded-2xl border border-border shadow-2xl z-20 w-[90%] sm:w-auto">
                            ...
                            <div className="space-y-8">
                                <div className="bg-surface border border-border rounded-3xl shadow-xl p-6 space-y-4">
                                    <h3 className="font-bold text-lg text-primary">OCR Settings</h3>
                                    <div className="space-y-4">
                                        <label className="block text-sm font-semibold text-secondary">Language</label>
                                        <select
                                            value={ocrLanguage}
                                            onChange={(e) => setOcrLanguage(e.target.value)}
                                            className="w-full bg-inset border border-border rounded-xl px-4 py-3 text-sm focus:ring-2 ring-emerald-500 font-bold text-primary"
                                        >
                                    ...
                                    <div className="space-y-3">
                                        <button
                                            onClick={() => runOCR('full')}
                                            disabled={isProcessing}
                                            className="w-full py-4 bg-emerald-500 text-white rounded-xl font-bold hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-500/20 flex items-center justify-center gap-3 relative overflow-hidden disabled:opacity-50"
                                        >
                                            {isProcessing ? (
                                                <>
                                        ...
                                        <button
                                            ...
                                            className="w-full py-3 rounded-xl border border-border text-sm font-bold text-primary hover:bg-inset flex items-center justify-center gap-2 transition-all disabled:opacity-50"
                                        >
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <p className="text-xs font-bold uppercase tracking-widest text-secondary">Manage Pages</p>
                                        <span className="text-[10px] text-secondary italic">Drag to reorder</span>
                                    </div>
                                    <Reorder.Group
                                        axis="y"
                                        values={scannedPages}
                                        ...
                                        {scannedPages.map((page, idx) => (
                                            <Reorder.Item
                                                ...
                                                className={`flex items-center gap-3 p-3 rounded-xl border transition-all cursor-grab active:cursor-grabbing ${activePageIndex === idx
                                                    ...
                                                    : 'bg-inset border-border hover:border-secondary'
                                                    }`}
                                                onClick={() => setActivePageIndex(idx)}
                                            >
                                                <GripVertical size={16} className="text-secondary shrink-0" />
                                                <div className="w-10 h-13 rounded bg-black/20 overflow-hidden shrink-0 border border-border">
                                                    <img src={page.processed} className="w-full h-full object-cover" />
                                                </div>
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-sm font-bold truncate text-primary">Page {idx + 1}</p>
                                                    <p className="text-[10px] text-secondary truncate capitalize">{page.filter} Filter</p>
                                                </div>
                                                <button
                        ...
                        >
                            <div className="flex flex-col lg:flex-row gap-8">
                                <div className="flex-1 space-y-6">
                                    <div className="bg-surface border border-border rounded-3xl shadow-xl p-6 min-h-[500px] flex flex-col">
                                        <div className="flex items-center justify-between mb-4 border-b border-border pb-4">
                                            <h3 className="flex items-center gap-2 font-bold text-lg text-primary">
                                                <Edit3 size={18} className="text-emerald-500" /> Extracted Text
                                            </h3>
                                            <div className="flex gap-2">
                                                <button
                                                    onClick={() => setExtractedText(cleanTextData(extractedText))}
                                                    className="flex items-center gap-2 px-3 py-1.5 bg-emerald-500/10 text-emerald-500 rounded-lg hover:bg-emerald-500/20 transition-all text-sm font-bold"
                                        ...
                                        <textarea
                                            ...
                                            className="flex-1 w-full bg-transparent border-none focus:ring-0 text-lg leading-relaxed resize-none font-medium custom-scrollbar text-primary"
                                ...
                                <div className="w-full md:w-80 space-y-6">
                                    <div className="bg-surface border border-border rounded-3xl shadow-xl p-8 bg-gradient-to-br from-emerald-500/20 to-transparent border-emerald-500/30 space-y-6">
                                        <div className="w-16 h-16 rounded-2xl bg-emerald-500 text-white shadow-xl shadow-emerald-500/20 flex items-center justify-center">
                                            <Download size={32} />
                                        </div>
                                        <div>
                                            <h3 className="text-2xl font-bold text-primary">Ready to Save?</h3>
                                            <p className="text-sm text-secondary mt-1">Export your document in high-quality professional formats.</p>
                                        </div>
                                        <div className="space-y-3 pt-4">
                                            <button onClick={exportToTxt} className="w-full flex items-center justify-between p-4 bg-background border border-border rounded-xl font-bold hover:border-emerald-500 transition-all text-primary">
                                                <span className="flex items-center gap-3"><FileText size={18} /> TXT</span>
                                                <ArrowRight size={14} className="opacity-40" />
                                            </button>
                                            <button onClick={exportToPdf} className="w-full flex items-center justify-between p-4 bg-background border border-border rounded-xl font-bold hover:border-emerald-500 transition-all text-primary">
                                                <span className="flex items-center gap-3"><ImageIcon size={18} /> PDF</span>
                                                <ArrowRight size={14} className="opacity-40" />
                                            </button>
                                            <button onClick={exportToDocx} className="w-full flex items-center justify-between p-4 bg-background border border-border rounded-xl font-bold hover:border-emerald-500 transition-all text-primary">
                                    ...
                                    <button
                                        onClick={() => setStep(1)}
                                        className="w-full py-4 text-sm font-bold text-secondary hover:text-primary transition-colors flex items-center justify-center gap-2"
                                    >
